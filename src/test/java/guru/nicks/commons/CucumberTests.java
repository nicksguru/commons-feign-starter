 ...
 * were a unit test) instead of {@code mvn verify}. The reason is that CI pipelines are often configured to collect
 * test code coverage metrics from unit tests only - {@code mvn verify} is not run.
 */
@Suite
